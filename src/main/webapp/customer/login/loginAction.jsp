											...
											<tr>
												<td colspan="2" style="border-bottom: none">
													...
													<div align="right">
														...
														<input class="inputButton" type="button" value="회원탈퇴" onclick="window.location='/jsp_pj_ict05/deleteCustomerCustomer.do'">
														<input class="inputButton" type="button" value="로그아웃" onclick="window.location='/jsp_pj_ict05/logout.do'"><!-- controller의 .do로 감. -->
													</div>
												</td>
											</tr>
										</table>
